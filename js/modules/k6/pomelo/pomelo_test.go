...
func Test_Split(t *testing.T) {
	...
	var (
		srcFilePath = "/Users/zhengjm/ztproduct/ledu/k6/prod/courseid_classid_stuid_uid_card_subjectId_teacherEmpNo_tutorEmpNo_chapterId_50000_total_(1).txt"
		tarPaht     = "/Users/zhengjm/ztproduct/ledu/k6/prod/courseid_%d.txt"
	)
	...
	for j := 0; j < 10; j++ {
		...
		tfile, err := os.Create(fmt.Sprintf(tarPaht, index))
		if err != nil {
			log.Fatal(err)
		}
		...
		tfile.Sync() // Sync commits the current contents of the file to stable storage.
